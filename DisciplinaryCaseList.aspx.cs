...
namespace HRMS
{
    public partial class DisciplinaryCaseList : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                var role = lstUserRole
                    .FirstOrDefault(x => string.Equals(x.Page_Name.Trim(), "Disciplinary Case List", StringComparison.OrdinalIgnoreCase)
        ...
        {
            var disciplinaryCases = ODataServices.GetDisciplinaryList(Session["SessionCompanyName"] as string);
        ...
        {
            var servicePath = SOAPServices.ExportDisciplinaryDetailsPreview(Session["SessionCompanyName"] as string);
            var FileName = "DisciplinaryDetails.XLS";
