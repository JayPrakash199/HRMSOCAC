...
namespace HRMS
{
    public partial class AERPartCList : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                var role = lstUserRole
                    .FirstOrDefault(x => string.Equals(x.Page_Name.Trim(), "Non-Regular List", StringComparison.OrdinalIgnoreCase)
        ...
        private void BindListView()
        {
            ...
            aerPartCListView.DataSource = annualEstablishmentReviewList
                .Where(x => x.Establishment_Type == "Part – C (Non-regular Establishment)");
            aerPartCListView.DataBind();
        }

        protected void btnExport_Click(object sender, EventArgs e)
        {
            var servicePath = SOAPServices.ExportAnnualEstablishmentPartC(Session["SessionCompanyName"] as string);
            var FileName = "AnnualEstablishmentPartC.XLS";
