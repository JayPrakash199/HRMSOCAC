...
namespace HRMS
{
    public partial class AERPartEList : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                var role = lstUserRole
                    .FirstOrDefault(x => string.Equals(x.Page_Name.Trim(), "Outsourced List", StringComparison.OrdinalIgnoreCase)
        ...
        private void BindListView()
        {
            ...
            aerPartEListView.DataSource = annualEstablishmentReviewList
                .Where(x => x.Establishment_Type == "Part – E (Outsourced/ on contract)");
            aerPartEListView.DataBind();
        }

        protected void btnExport_Click(object sender, EventArgs e)
        {
            var servicePath = SOAPServices.ExportAnnualEstablishmentPartE(Session["SessionCompanyName"] as string);
            var FileName = "AnnualEstablishmentPartE.XLS";
